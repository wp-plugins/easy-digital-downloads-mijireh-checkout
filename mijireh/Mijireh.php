...
require_once EMIJ_PLUGIN_DIR . '/mijireh/Model.php';
require_once EMIJ_PLUGIN_DIR . '/mijireh/Address.php';
require_once EMIJ_PLUGIN_DIR . '/mijireh/Item.php';
require_once EMIJ_PLUGIN_DIR . '/mijireh/Order.php';
